  ...
  if (status === "success") return (
    <div style={s.bg}><div style={s.blob1}/><div style={s.blob2}/>
      <div style={{...s.card,textAlign:"center"}}>
        ...
        <h2 style={s.title}>Checked In!</h2>
        <p style={{color:"#a78bfa",marginTop:8}}>You earned</p>
        <p style={{fontSize:28,fontWeight:800,color:"#4ade80",margin:"8px 0"}}>+100 XTP</p>
    ...
    <div style={s.bg}><div style={s.blob1}/><div style={s.blob2}/>
      <div style={s.card}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:20}}>
          <div>
            <h1 style={{fontSize:20,fontWeight:800,color:"#fff",margin:0}}>📅 Daily Check-in</h1>
            <p style={{fontSize:12,color:"#7c3aed",margin:0,marginTop:2}}>Check in every day</p>
          </div>
        ...
        <div style={s.walletBox}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            ...
            <div style={{textAlign:"right"}}><p style={s.label}>Reward</p><p style={{fontSize:20,color:"#4ade80",margin:0,fontWeight:800}}>+100 XTP</p></div>
          </div>
        </div>
        <div style={s.infoBox}>
          <div style={{display:"flex",justifyContent:"space-between",padding:"10px 0",borderBottom:"1px solid rgba(124,58,237,0.15)"}}>
            <span style={{color:"#a78bfa",fontSize:14}}>Check-in Fee</span>
            <span style={{color:"#fff",fontWeight:700}}>0.001 USDC</span>
          </div>
        ...
        {needsApproval ? (
          ...
          <button onClick={handleCheckin} disabled={status==="depositing"} style={{...s.btn,background:status==="depositing"?"#2d1b69":"linear-gradient(135deg,#7c3aed,#4f46e5)",opacity:status==="depositing"?0.7:1}}>
            {status==="depositing"?"⏳ Processing...":"💎 Pay 0.001 USDC & Check-in"}
          </button>
        )}
