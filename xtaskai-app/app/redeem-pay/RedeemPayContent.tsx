  ...
  if (status === "success") return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md w-full bg-white rounded-2xl shadow-lg p-8">
        ...
        <p className="text-gray-600">You received:{reward_usdc > 0 ? ` $${reward_usdc} USDC` : ""}{reward_xtp > 0 ? ` ${reward_xtp} XTP` : ""}</p>
  ...
  if (!code_id || !code) return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md w-full bg-white rounded-2xl shadow-lg p-8">
        ...
        <p className="text-gray-600 mb-6">Please go back and enter your code.</p>
        <button onClick={() => window.location.href="https://xtaskai.com/base-mini-app/redeem.php"} className="w-full bg-blue-600 text-white py-3 rounded-xl">Go Back</button>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold mb-2">Claim Reward</h1>
